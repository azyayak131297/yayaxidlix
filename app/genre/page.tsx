  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-red-900/10 rounded-full blur-[180px]" />
      </div>
      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="relative mb-10">
          ...
          <h1 className="text-3xl font-extrabold text-red-400 mb-2 tracking-tight">Genre</h1>
          <p className="text-zinc-400 text-sm md:text-base">
            Pilih genre untuk mengeksplorasi film dan series <span className="text-red-400">•</span> Film &amp; Series
          </p>
        </div>
        ...
        {genres.length === 0 ? (
          <div className="relative rounded-2xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm overflow-hidden">
            ...
            <div className="relative flex flex-col items-center justify-center py-24 px-6 text-center">
              ...
              <h2 className="text-xl font-bold text-zinc-200 mb-2">Genre belum tersedia</h2>
              <p className="text-zinc-500 text-sm max-w-md">
                Isi <code className="text-red-400 bg-zinc-800 px-1.5 py-0.5 rounded text-xs">TMDB_API_KEY</code> di{" "}
                <code className="text-red-400 bg-zinc-800 px-1.5 py-0.5 rounded text-xs">.env</code> untuk memuat daftar genre.
              </p>
              <Link
                href="/admin"
