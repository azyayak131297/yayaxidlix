...
export default function AdminLocalBulkClient() {
  useEffect(() => {
    const form = document.querySelector('form[action="/api/admin/local-content/bulk"]') as HTMLFormElement | null
    if (!form) return

    const selectAllCheckbox = document.getElementById('select-all-local') as HTMLInputElement | null
