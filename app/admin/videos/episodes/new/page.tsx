...
export default function NewEpisodeVideoPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold">Tambah Video Episode</h1>
            <p className="text-zinc-400 mt-1">Hubungkan video dengan episode series.</p>
          </div>
